...
- The caller needs a data-plane role carrying `artifactregistry.repositories.downloadArtifacts` on the repository (proven: `roles/artifactregistry.writer` carries it).
