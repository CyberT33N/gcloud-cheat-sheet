# `roles/admin` — `ml` permissions

`roles/admin` grants 38 permissions in the `ml` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
