# `roles/admin` — `dataconnectors` permissions

`roles/admin` grants 14 permissions in the `dataconnectors` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
