# `roles/admin` — `cloudtrace` permissions

`roles/admin` grants 15 permissions in the `cloudtrace` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
