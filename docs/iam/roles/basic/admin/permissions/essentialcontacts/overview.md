# `roles/admin` — `essentialcontacts` permissions

`roles/admin` grants 6 permissions in the `essentialcontacts` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
