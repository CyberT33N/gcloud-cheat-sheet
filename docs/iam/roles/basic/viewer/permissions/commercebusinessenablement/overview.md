# `roles/viewer` — `commercebusinessenablement` permissions

`roles/viewer` grants 15 permissions in the `commercebusinessenablement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
