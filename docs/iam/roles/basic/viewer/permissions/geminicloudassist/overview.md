# `roles/viewer` — `geminicloudassist` permissions

`roles/viewer` grants 12 permissions in the `geminicloudassist` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
