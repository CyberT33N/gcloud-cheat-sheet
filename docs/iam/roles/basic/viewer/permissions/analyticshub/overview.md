# `roles/viewer` — `analyticshub` permissions

`roles/viewer` grants 10 permissions in the `analyticshub` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
