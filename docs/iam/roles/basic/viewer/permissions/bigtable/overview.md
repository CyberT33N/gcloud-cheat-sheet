# `roles/viewer` — `bigtable` permissions

`roles/viewer` grants 47 permissions in the `bigtable` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
