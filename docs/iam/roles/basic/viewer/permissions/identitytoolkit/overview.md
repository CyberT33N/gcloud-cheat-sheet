# `roles/viewer` — `identitytoolkit` permissions

`roles/viewer` grants 3 permissions in the `identitytoolkit` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
