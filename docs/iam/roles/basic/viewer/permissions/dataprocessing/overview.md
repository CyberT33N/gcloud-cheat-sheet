# `roles/viewer` — `dataprocessing` permissions

`roles/viewer` grants 5 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
