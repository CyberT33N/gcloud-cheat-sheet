# `roles/viewer` — `recaptchaenterprise` permissions

`roles/viewer` grants 11 permissions in the `recaptchaenterprise` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
