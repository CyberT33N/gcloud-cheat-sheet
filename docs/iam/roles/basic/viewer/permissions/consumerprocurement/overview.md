# `roles/viewer` — `consumerprocurement` permissions

`roles/viewer` grants 14 permissions in the `consumerprocurement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
