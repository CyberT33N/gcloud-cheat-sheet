# `roles/editor` — `firebasedataconnect` permissions

`roles/editor` grants 35 permissions in the `firebasedataconnect` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
