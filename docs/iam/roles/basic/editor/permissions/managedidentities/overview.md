# `roles/editor` — `managedidentities` permissions

`roles/editor` grants 40 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
