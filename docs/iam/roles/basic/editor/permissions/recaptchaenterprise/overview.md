# `roles/editor` — `recaptchaenterprise` permissions

`roles/editor` grants 22 permissions in the `recaptchaenterprise` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
