# `roles/editor` — `dataprocessing` permissions

`roles/editor` grants 6 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
