# `roles/editor` — `speakerid` permissions

`roles/editor` grants 10 permissions in the `speakerid` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
