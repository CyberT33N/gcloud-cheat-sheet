# `roles/editor` — `dataconnectors` permissions

`roles/editor` grants 13 permissions in the `dataconnectors` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
