# `roles/editor` — `apigateway` permissions

`roles/editor` grants 28 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
