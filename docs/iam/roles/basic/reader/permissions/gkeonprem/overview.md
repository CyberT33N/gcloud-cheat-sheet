# `roles/reader` — `gkeonprem` permissions

`roles/reader` grants 35 permissions in the `gkeonprem` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
