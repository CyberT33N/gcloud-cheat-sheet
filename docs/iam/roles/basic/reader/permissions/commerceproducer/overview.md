# `roles/reader` — `commerceproducer` permissions

`roles/reader` grants 20 permissions in the `commerceproducer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
