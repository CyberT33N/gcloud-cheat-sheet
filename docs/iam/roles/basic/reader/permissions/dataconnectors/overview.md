# `roles/reader` — `dataconnectors` permissions

`roles/reader` grants 7 permissions in the `dataconnectors` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
