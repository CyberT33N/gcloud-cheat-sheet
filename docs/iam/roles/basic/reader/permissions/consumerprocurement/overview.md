# `roles/reader` — `consumerprocurement` permissions

`roles/reader` grants 14 permissions in the `consumerprocurement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
