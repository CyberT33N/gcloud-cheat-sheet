# `roles/reader` — `datalabeling` permissions

`roles/reader` grants 16 permissions in the `datalabeling` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
