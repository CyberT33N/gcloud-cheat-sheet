# `roles/reader` — `managedkafka` permissions

`roles/reader` grants 32 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
