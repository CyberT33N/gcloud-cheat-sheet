# `roles/reader` — `oracledatabase` permissions

`roles/reader` grants 51 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
