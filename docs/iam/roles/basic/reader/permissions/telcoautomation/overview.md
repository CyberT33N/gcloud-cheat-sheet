# `roles/reader` — `telcoautomation` permissions

`roles/reader` grants 17 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
