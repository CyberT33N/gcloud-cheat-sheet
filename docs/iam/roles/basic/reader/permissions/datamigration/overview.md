# `roles/reader` — `datamigration` permissions

`roles/reader` grants 28 permissions in the `datamigration` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
