# `roles/reader` — `speakerid` permissions

`roles/reader` grants 5 permissions in the `speakerid` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
