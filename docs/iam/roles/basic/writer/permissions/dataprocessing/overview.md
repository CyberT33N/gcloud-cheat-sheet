# `roles/writer` — `dataprocessing` permissions

`roles/writer` grants 6 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
