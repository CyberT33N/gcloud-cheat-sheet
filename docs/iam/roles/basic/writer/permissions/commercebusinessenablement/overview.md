# `roles/writer` — `commercebusinessenablement` permissions

`roles/writer` grants 33 permissions in the `commercebusinessenablement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
