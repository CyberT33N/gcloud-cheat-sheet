# `roles/writer` — `telcoautomation` permissions

`roles/writer` grants 32 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
