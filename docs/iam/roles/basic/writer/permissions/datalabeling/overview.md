# `roles/writer` — `datalabeling` permissions

`roles/writer` grants 25 permissions in the `datalabeling` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
