# `roles/writer` — `managedidentities` permissions

`roles/writer` grants 40 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
