# `roles/writer` — `gkeonprem` permissions

`roles/writer` grants 64 permissions in the `gkeonprem` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
