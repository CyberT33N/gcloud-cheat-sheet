# `roles/owner` — `recaptchaenterprise` permissions

`roles/owner` grants 24 permissions in the `recaptchaenterprise` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
