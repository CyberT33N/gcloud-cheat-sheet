# `roles/owner` — `cloudbuild` permissions

`roles/owner` grants 35 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
