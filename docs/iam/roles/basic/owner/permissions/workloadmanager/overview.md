# `roles/owner` — `workloadmanager` permissions

`roles/owner` grants 34 permissions in the `workloadmanager` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
