# `roles/owner` — `commercebusinessenablement` permissions

`roles/owner` grants 33 permissions in the `commercebusinessenablement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
