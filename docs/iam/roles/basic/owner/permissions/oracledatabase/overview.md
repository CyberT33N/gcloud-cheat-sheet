# `roles/owner` — `oracledatabase` permissions

`roles/owner` grants 106 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
