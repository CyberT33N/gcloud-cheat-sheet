# `roles/owner` — `telcoautomation` permissions

`roles/owner` grants 35 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
