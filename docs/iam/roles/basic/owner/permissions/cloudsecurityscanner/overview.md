# `roles/owner` — `cloudsecurityscanner` permissions

`roles/owner` grants 13 permissions in the `cloudsecurityscanner` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
