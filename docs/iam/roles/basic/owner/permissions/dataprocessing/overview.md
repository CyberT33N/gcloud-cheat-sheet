# `roles/owner` — `dataprocessing` permissions

`roles/owner` grants 8 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).
