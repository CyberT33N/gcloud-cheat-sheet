# `roles/apphub.appManagementViewer` — `config` permissions

`roles/apphub.appManagementViewer` grants 20 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
