# `roles/bigtable.reader` — `bigtable` permissions

`roles/bigtable.reader` grants 35 permissions in the `bigtable` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
