# `roles/bigtable.user` — `monitoring` permissions

`roles/bigtable.user` grants 4 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
