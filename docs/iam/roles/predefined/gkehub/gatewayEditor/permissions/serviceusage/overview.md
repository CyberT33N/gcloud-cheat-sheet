# `roles/gkehub.gatewayEditor` — `serviceusage` permissions

`roles/gkehub.gatewayEditor` grants 8 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
