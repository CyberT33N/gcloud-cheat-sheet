# `roles/gkehub.gatewayAdmin` — `serviceusage` permissions

`roles/gkehub.gatewayAdmin` grants 8 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/gkehub.gatewayAdmin`](../../overview.md)
