# `roles/gkehub.scopeViewerProjectLevel` — `serviceusage` permissions

`roles/gkehub.scopeViewerProjectLevel` grants 8 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
