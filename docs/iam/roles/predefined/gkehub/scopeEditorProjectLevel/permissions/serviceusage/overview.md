# `roles/gkehub.scopeEditorProjectLevel` — `serviceusage` permissions

`roles/gkehub.scopeEditorProjectLevel` grants 8 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
