# `roles/assuredoss.projectAdmin` — `artifactregistry` permissions

`roles/assuredoss.projectAdmin` grants 33 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
