# `roles/assuredoss.projectAdmin` — `serviceusage` permissions

`roles/assuredoss.projectAdmin` grants 11 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
