# `roles/assuredoss.user` — `artifactregistry` permissions

`roles/assuredoss.user` grants 32 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/assuredoss.user`](../../overview.md)
