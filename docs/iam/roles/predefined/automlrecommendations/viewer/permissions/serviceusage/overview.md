# `roles/automlrecommendations.viewer` — `serviceusage` permissions

`roles/automlrecommendations.viewer` grants 9 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
