# `roles/containeranalysis.ServiceAgent` — `serviceusage` permissions

`roles/containeranalysis.ServiceAgent` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
