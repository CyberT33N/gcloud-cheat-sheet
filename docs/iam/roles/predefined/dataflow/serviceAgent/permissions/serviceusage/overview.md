# `roles/dataflow.serviceAgent` — `serviceusage` permissions

`roles/dataflow.serviceAgent` grants 11 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
