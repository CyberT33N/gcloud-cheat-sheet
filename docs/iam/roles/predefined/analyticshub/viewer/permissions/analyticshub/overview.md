# `roles/analyticshub.viewer` — `analyticshub` permissions

`roles/analyticshub.viewer` grants 8 permissions in the `analyticshub` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
