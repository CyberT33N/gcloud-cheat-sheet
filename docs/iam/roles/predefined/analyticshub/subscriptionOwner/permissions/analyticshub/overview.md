# `roles/analyticshub.subscriptionOwner` — `analyticshub` permissions

`roles/analyticshub.subscriptionOwner` grants 13 permissions in the `analyticshub` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/analyticshub.subscriptionOwner`](../../overview.md)
