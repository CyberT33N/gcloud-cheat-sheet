# `roles/analyticshub.listingAdmin` — `analyticshub` permissions

`roles/analyticshub.listingAdmin` grants 12 permissions in the `analyticshub` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/analyticshub.listingAdmin`](../../overview.md)
