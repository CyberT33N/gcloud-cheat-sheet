# `roles/workloadmanager.viewer` — `workloadmanager` permissions

`roles/workloadmanager.viewer` grants 14 permissions in the `workloadmanager` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
