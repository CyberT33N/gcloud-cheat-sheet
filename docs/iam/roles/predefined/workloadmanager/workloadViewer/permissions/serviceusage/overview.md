# `roles/workloadmanager.workloadViewer` — `serviceusage` permissions

`roles/workloadmanager.workloadViewer` grants 9 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
