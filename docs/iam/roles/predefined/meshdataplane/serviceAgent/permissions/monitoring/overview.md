# `roles/meshdataplane.serviceAgent` — `monitoring` permissions

`roles/meshdataplane.serviceAgent` grants 6 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
