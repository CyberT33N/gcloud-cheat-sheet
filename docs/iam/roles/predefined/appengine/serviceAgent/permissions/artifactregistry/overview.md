# `roles/appengine.serviceAgent` — `artifactregistry` permissions

`roles/appengine.serviceAgent` grants 33 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
