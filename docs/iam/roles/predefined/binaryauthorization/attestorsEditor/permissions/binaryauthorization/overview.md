# `roles/binaryauthorization.attestorsEditor` — `binaryauthorization` permissions

`roles/binaryauthorization.attestorsEditor` grants 6 permissions in the `binaryauthorization` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/binaryauthorization.attestorsEditor`](../../overview.md)
