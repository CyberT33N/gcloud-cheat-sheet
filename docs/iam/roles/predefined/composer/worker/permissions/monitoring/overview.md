# `roles/composer.worker` — `monitoring` permissions

`roles/composer.worker` grants 7 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
