# `roles/managedidentities.viewer` — `managedidentities` permissions

`roles/managedidentities.viewer` grants 17 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/managedidentities.viewer`](../../overview.md)
