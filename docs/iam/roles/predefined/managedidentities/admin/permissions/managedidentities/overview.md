# `roles/managedidentities.admin` — `managedidentities` permissions

`roles/managedidentities.admin` grants 45 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
- [`managedidentities.domains.setIamPolicy`](../../../../../../permissions/managedidentities/domains/overview.md)
...
- [`managedidentities.peerings.setIamPolicy`](../../../../../../permissions/managedidentities/peerings/overview.md)
