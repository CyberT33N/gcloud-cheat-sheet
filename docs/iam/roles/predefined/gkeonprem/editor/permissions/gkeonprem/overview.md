# `roles/gkeonprem.editor` — `gkeonprem` permissions

`roles/gkeonprem.editor` grants 64 permissions in the `gkeonprem` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
