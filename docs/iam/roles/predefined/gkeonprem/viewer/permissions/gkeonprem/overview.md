# `roles/gkeonprem.viewer` — `gkeonprem` permissions

`roles/gkeonprem.viewer` grants 35 permissions in the `gkeonprem` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
