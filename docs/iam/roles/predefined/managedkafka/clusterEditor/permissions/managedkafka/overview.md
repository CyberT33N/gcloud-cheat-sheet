# `roles/managedkafka.clusterEditor` — `managedkafka` permissions

`roles/managedkafka.clusterEditor` grants 35 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
