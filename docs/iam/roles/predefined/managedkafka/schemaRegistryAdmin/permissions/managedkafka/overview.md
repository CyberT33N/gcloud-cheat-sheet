# `roles/managedkafka.schemaRegistryAdmin` — `managedkafka` permissions

`roles/managedkafka.schemaRegistryAdmin` grants 25 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/managedkafka.schemaRegistryAdmin`](../../overview.md)
