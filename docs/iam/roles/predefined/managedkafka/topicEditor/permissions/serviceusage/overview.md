# `roles/managedkafka.topicEditor` — `serviceusage` permissions

`roles/managedkafka.topicEditor` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
