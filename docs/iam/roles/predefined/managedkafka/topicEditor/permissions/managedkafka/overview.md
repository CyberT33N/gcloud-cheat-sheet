# `roles/managedkafka.topicEditor` — `managedkafka` permissions

`roles/managedkafka.topicEditor` grants 35 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
