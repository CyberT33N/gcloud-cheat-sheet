# `roles/managedkafka.viewer` — `managedkafka` permissions

`roles/managedkafka.viewer` grants 32 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
