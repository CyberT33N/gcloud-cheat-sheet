# `roles/managedkafka.client` — `managedkafka` permissions

`roles/managedkafka.client` grants 39 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
