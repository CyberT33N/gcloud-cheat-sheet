# `roles/container.defaultNodeServiceAccount` — `monitoring` permissions

`roles/container.defaultNodeServiceAccount` grants 4 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/container.defaultNodeServiceAccount`](../../overview.md)
