# `roles/dlp.projectdriver` — `recaptchaenterprise` permissions

`roles/dlp.projectdriver` grants 4 permissions in the `recaptchaenterprise` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
