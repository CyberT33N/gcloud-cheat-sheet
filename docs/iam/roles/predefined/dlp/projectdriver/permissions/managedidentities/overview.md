# `roles/dlp.projectdriver` — `managedidentities` permissions

`roles/dlp.projectdriver` grants 4 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
