# `roles/dlp.projectdriver` — `privateca` permissions

`roles/dlp.projectdriver` grants 8 permissions in the `privateca` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
