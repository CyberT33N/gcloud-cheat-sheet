# `roles/dlp.orgdriver` — `privateca` permissions

`roles/dlp.orgdriver` grants 8 permissions in the `privateca` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
