# `roles/deploymentmanager.typeEditor` — `serviceusage` permissions

`roles/deploymentmanager.typeEditor` grants 9 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/deploymentmanager.typeEditor`](../../overview.md)
