# `roles/deploymentmanager.typeViewer` — `serviceusage` permissions

`roles/deploymentmanager.typeViewer` grants 9 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/deploymentmanager.typeViewer`](../../overview.md)
