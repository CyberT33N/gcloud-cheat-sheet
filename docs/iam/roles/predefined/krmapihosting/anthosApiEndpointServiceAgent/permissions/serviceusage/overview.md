# `roles/krmapihosting.anthosApiEndpointServiceAgent` — `serviceusage` permissions

`roles/krmapihosting.anthosApiEndpointServiceAgent` grants 12 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
