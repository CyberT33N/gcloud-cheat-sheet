# `roles/datapipelines.serviceAgent` — `cloudbuild` permissions

`roles/datapipelines.serviceAgent` grants 8 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
