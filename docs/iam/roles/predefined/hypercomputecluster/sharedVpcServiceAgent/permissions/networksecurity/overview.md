# `roles/hypercomputecluster.sharedVpcServiceAgent` — `networksecurity` permissions

`roles/hypercomputecluster.sharedVpcServiceAgent` grants 47 permissions in the `networksecurity` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
