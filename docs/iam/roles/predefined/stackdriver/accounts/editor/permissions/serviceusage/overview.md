# `roles/stackdriver.accounts.editor` — `serviceusage` permissions

`roles/stackdriver.accounts.editor` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../../permissions/overview.md).
...
Role: [`roles/stackdriver.accounts.editor`](../../overview.md)
