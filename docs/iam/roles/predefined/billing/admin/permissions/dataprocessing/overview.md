# `roles/billing.admin` — `dataprocessing` permissions

`roles/billing.admin` grants 4 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
