# `roles/billing.viewer` — `dataprocessing` permissions

`roles/billing.viewer` grants 4 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
