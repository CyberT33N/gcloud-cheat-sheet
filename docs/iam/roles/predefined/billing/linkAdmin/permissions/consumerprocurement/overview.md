# `roles/billing.linkAdmin` — `consumerprocurement` permissions

`roles/billing.linkAdmin` grants 8 permissions in the `consumerprocurement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
