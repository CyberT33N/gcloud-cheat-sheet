# `roles/speakerid.editor` — `speakerid` permissions

`roles/speakerid.editor` grants 9 permissions in the `speakerid` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/speakerid.editor`](../../overview.md)
