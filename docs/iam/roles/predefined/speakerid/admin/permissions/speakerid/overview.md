# `roles/speakerid.admin` — `speakerid` permissions

`roles/speakerid.admin` grants 11 permissions in the `speakerid` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/speakerid.admin`](../../overview.md)
