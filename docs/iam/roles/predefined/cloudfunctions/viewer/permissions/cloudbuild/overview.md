# `roles/cloudfunctions.viewer` — `cloudbuild` permissions

`roles/cloudfunctions.viewer` grants 6 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
