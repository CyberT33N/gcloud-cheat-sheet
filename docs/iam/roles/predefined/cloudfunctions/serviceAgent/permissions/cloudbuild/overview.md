# `roles/cloudfunctions.serviceAgent` — `cloudbuild` permissions

`roles/cloudfunctions.serviceAgent` grants 9 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
