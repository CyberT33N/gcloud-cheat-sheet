# `roles/cloudfunctions.serviceAgent` — `serviceusage` permissions

`roles/cloudfunctions.serviceAgent` grants 13 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
