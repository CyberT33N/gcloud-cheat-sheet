# `roles/cloudfunctions.editor` — `artifactregistry` permissions

`roles/cloudfunctions.editor` grants 32 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
