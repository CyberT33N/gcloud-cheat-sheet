# `roles/iam.supportUser` — `managedidentities` permissions

`roles/iam.supportUser` grants 19 permissions in the `managedidentities` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
