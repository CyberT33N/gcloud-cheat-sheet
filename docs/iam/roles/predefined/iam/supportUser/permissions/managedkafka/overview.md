# `roles/iam.supportUser` — `managedkafka` permissions

`roles/iam.supportUser` grants 32 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
