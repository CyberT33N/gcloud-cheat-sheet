# `roles/iam.supportUser` — `actions` permissions

`roles/iam.supportUser` grants 3 permissions in the `actions` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
