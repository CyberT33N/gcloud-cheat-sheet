# `roles/iam.supportUser` — `cloudtranslate` permissions

`roles/iam.supportUser` grants 31 permissions in the `cloudtranslate` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
