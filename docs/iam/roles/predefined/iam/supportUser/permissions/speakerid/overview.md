# `roles/iam.supportUser` — `speakerid` permissions

`roles/iam.supportUser` grants 5 permissions in the `speakerid` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
