# `roles/iam.supportUser` — `firebasedataconnect` permissions

`roles/iam.supportUser` grants 17 permissions in the `firebasedataconnect` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
