# `roles/iam.supportUser` — `apigateway` permissions

`roles/iam.supportUser` grants 17 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
