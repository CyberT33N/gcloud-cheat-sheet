# `roles/iam.supportUser` — `cloudbuild` permissions

`roles/iam.supportUser` grants 17 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
