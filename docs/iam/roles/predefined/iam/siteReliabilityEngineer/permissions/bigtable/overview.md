# `roles/iam.siteReliabilityEngineer` — `bigtable` permissions

`roles/iam.siteReliabilityEngineer` grants 26 permissions in the `bigtable` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
