# `roles/iam.siteReliabilityEngineer` — `cloudtrace` permissions

`roles/iam.siteReliabilityEngineer` grants 14 permissions in the `cloudtrace` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
