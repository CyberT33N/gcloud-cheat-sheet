# `roles/iam.dataScientist` — `serviceusage` permissions

`roles/iam.dataScientist` grants 13 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
