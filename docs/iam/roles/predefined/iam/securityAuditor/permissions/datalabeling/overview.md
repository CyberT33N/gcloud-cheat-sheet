# `roles/iam.securityAuditor` — `datalabeling` permissions

`roles/iam.securityAuditor` grants 7 permissions in the `datalabeling` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
