# `roles/iam.securityAuditor` — `consumerprocurement` permissions

`roles/iam.securityAuditor` grants 7 permissions in the `consumerprocurement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
