# `roles/iam.securityAuditor` — `cloudtrace` permissions

`roles/iam.securityAuditor` grants 4 permissions in the `cloudtrace` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
