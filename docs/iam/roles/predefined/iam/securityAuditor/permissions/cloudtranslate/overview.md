# `roles/iam.securityAuditor` — `cloudtranslate` permissions

`roles/iam.securityAuditor` grants 9 permissions in the `cloudtranslate` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
