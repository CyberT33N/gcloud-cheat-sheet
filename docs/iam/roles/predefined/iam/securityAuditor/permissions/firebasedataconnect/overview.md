# `roles/iam.securityAuditor` — `firebasedataconnect` permissions

`roles/iam.securityAuditor` grants 7 permissions in the `firebasedataconnect` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
