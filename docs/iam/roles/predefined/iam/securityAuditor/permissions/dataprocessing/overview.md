# `roles/iam.securityAuditor` — `dataprocessing` permissions

`roles/iam.securityAuditor` grants 3 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
