# `roles/iam.securityAuditor` — `managedkafka` permissions

`roles/iam.securityAuditor` grants 12 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
