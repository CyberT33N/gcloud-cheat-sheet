# `roles/iam.securityAuditor` — `networksecurity` permissions

`roles/iam.securityAuditor` grants 55 permissions in the `networksecurity` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
