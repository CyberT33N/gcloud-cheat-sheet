# `roles/iam.securityAuditor` — `workloadmanager` permissions

`roles/iam.securityAuditor` grants 10 permissions in the `workloadmanager` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
