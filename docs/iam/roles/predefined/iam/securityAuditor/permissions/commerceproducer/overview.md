# `roles/iam.securityAuditor` — `commerceproducer` permissions

`roles/iam.securityAuditor` grants 10 permissions in the `commerceproducer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
