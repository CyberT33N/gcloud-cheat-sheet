# `roles/iam.securityAuditor` — `networkconnectivity` permissions

`roles/iam.securityAuditor` grants 35 permissions in the `networkconnectivity` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
