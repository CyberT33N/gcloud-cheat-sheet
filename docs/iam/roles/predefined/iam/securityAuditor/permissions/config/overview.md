# `roles/iam.securityAuditor` — `config` permissions

`roles/iam.securityAuditor` grants 12 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
