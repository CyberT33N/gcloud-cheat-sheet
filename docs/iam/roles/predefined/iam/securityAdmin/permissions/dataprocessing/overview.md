# `roles/iam.securityAdmin` — `dataprocessing` permissions

`roles/iam.securityAdmin` grants 3 permissions in the `dataprocessing` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
