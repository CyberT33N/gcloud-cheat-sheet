# `roles/iam.securityAdmin` — `commercebusinessenablement` permissions

`roles/iam.securityAdmin` grants 6 permissions in the `commercebusinessenablement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
