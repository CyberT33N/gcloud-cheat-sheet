# `roles/iam.securityAdmin` — `datalabeling` permissions

`roles/iam.securityAdmin` grants 7 permissions in the `datalabeling` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
