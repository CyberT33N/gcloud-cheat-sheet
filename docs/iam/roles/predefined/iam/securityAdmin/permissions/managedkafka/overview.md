# `roles/iam.securityAdmin` — `managedkafka` permissions

`roles/iam.securityAdmin` grants 12 permissions in the `managedkafka` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
