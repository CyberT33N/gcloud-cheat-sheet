# `roles/iam.securityAdmin` — `cloudtranslate` permissions

`roles/iam.securityAdmin` grants 9 permissions in the `cloudtranslate` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
