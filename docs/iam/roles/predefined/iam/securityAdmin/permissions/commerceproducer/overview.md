# `roles/iam.securityAdmin` — `commerceproducer` permissions

`roles/iam.securityAdmin` grants 10 permissions in the `commerceproducer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
