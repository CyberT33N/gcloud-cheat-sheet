# `roles/iam.securityAdmin` — `cloudsecurityscanner` permissions

`roles/iam.securityAdmin` grants 4 permissions in the `cloudsecurityscanner` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
