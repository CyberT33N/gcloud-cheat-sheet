# `roles/iam.securityAdmin` — `firebasedataconnect` permissions

`roles/iam.securityAdmin` grants 7 permissions in the `firebasedataconnect` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
