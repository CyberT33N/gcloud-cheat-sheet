# `roles/iam.securityAdmin` — `cloudbuild` permissions

`roles/iam.securityAdmin` grants 9 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
