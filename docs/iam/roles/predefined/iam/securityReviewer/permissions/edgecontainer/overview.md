# `roles/iam.securityReviewer` — `edgecontainer` permissions

`roles/iam.securityReviewer` grants 16 permissions in the `edgecontainer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
