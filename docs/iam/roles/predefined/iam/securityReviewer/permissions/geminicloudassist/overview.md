# `roles/iam.securityReviewer` — `geminicloudassist` permissions

`roles/iam.securityReviewer` grants 5 permissions in the `geminicloudassist` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
