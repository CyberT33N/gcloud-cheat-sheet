# `roles/iam.securityReviewer` — `oracledatabase` permissions

`roles/iam.securityReviewer` grants 34 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
