# `roles/iam.securityReviewer` — `consumerprocurement` permissions

`roles/iam.securityReviewer` grants 7 permissions in the `consumerprocurement` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
