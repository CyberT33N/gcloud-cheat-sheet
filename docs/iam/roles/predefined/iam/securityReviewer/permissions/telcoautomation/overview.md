# `roles/iam.securityReviewer` — `telcoautomation` permissions

`roles/iam.securityReviewer` grants 8 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
