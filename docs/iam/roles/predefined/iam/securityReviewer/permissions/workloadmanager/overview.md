# `roles/iam.securityReviewer` — `workloadmanager` permissions

`roles/iam.securityReviewer` grants 10 permissions in the `workloadmanager` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
