# `roles/iam.securityReviewer` — `config` permissions

`roles/iam.securityReviewer` grants 12 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
