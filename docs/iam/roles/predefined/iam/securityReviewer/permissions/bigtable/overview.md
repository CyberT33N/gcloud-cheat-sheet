# `roles/iam.securityReviewer` — `bigtable` permissions

`roles/iam.securityReviewer` grants 20 permissions in the `bigtable` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
