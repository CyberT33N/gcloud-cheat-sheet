# `roles/telcoautomation.opsAdminTier4` — `telcoautomation` permissions

`roles/telcoautomation.opsAdminTier4` grants 16 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
