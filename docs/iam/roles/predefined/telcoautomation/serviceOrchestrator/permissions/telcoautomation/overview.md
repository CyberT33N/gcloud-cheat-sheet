# `roles/telcoautomation.serviceOrchestrator` — `telcoautomation` permissions

`roles/telcoautomation.serviceOrchestrator` grants 16 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/telcoautomation.serviceOrchestrator`](../../overview.md)
