# `roles/telcoautomation.editor` — `telcoautomation` permissions

`roles/telcoautomation.editor` grants 32 permissions in the `telcoautomation` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
