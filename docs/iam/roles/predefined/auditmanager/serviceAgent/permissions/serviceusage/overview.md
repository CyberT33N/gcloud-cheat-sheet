# `roles/auditmanager.serviceAgent` — `serviceusage` permissions

`roles/auditmanager.serviceAgent` grants 14 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
