# `roles/compute.networkAdmin` — `serviceusage` permissions

`roles/compute.networkAdmin` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
