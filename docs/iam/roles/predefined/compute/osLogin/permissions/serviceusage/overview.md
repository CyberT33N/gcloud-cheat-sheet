# `roles/compute.osLogin` — `serviceusage` permissions

`roles/compute.osLogin` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
