...
| Launch stage | `GA` |
| Included permissions | 532 |
| Service | [compute](../../overview.md) |

## Permissions

`roles/compute.instanceAdmin.v1` grants 532 permissions across 5 services. Each service page lists exactly the permissions this role grants on that service and links every permission to its canonical page in the [central permission catalog](../../../../../permissions/overview.md).

| Service | Permissions |
| --- | --- |
| [backupdr](permissions/backupdr/overview.md) | 21 |
| [cloudkms](permissions/cloudkms/overview.md) | 5 |
| [compute](permissions/compute/overview.md) | 494 |
