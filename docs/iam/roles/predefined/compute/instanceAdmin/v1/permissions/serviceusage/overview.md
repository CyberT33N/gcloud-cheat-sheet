# `roles/compute.instanceAdmin.v1` — `serviceusage` permissions

`roles/compute.instanceAdmin.v1` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../../permissions/overview.md).
