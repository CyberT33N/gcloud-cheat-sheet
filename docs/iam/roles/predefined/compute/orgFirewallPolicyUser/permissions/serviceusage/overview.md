# `roles/compute.orgFirewallPolicyUser` — `serviceusage` permissions

`roles/compute.orgFirewallPolicyUser` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/compute.orgFirewallPolicyUser`](../../overview.md)
