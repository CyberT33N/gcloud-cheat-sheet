# `roles/compute.orgSecurityPolicyAdmin` — `serviceusage` permissions

`roles/compute.orgSecurityPolicyAdmin` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
