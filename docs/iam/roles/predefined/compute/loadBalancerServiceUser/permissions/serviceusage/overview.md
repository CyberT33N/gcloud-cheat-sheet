# `roles/compute.loadBalancerServiceUser` — `serviceusage` permissions

`roles/compute.loadBalancerServiceUser` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
