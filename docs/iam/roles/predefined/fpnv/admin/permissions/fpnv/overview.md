# `roles/fpnv.admin` — `fpnv` permissions

`roles/fpnv.admin` grants 3 permissions in the `fpnv` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/fpnv.admin`](../../overview.md)
