# `roles/firebasedataconnect.viewer` — `firebasedataconnect` permissions

`roles/firebasedataconnect.viewer` grants 17 permissions in the `firebasedataconnect` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/firebasedataconnect.viewer`](../../overview.md)
