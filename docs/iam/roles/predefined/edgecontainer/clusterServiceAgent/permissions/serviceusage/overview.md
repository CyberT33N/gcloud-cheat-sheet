# `roles/edgecontainer.clusterServiceAgent` — `serviceusage` permissions

`roles/edgecontainer.clusterServiceAgent` grants 15 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/edgecontainer.clusterServiceAgent`](../../overview.md)
