# `roles/edgecontainer.editor` — `edgecontainer` permissions

`roles/edgecontainer.editor` grants 62 permissions in the `edgecontainer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
