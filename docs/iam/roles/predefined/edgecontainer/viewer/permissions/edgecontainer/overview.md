# `roles/edgecontainer.viewer` — `edgecontainer` permissions

`roles/edgecontainer.viewer` grants 35 permissions in the `edgecontainer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/edgecontainer.viewer`](../../overview.md)
