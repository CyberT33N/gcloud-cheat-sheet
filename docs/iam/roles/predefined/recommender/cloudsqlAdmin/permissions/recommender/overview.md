# `roles/recommender.cloudsqlAdmin` — `recommender` permissions

`roles/recommender.cloudsqlAdmin` grants 51 permissions in the `recommender` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
