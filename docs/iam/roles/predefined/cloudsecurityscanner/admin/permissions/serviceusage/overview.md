# `roles/cloudsecurityscanner.admin` — `serviceusage` permissions

`roles/cloudsecurityscanner.admin` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
