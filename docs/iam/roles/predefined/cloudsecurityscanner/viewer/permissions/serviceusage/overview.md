# `roles/cloudsecurityscanner.viewer` — `serviceusage` permissions

`roles/cloudsecurityscanner.viewer` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/cloudsecurityscanner.viewer`](../../overview.md)
