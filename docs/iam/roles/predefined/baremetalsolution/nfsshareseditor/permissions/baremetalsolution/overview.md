# `roles/baremetalsolution.nfsshareseditor` — `baremetalsolution` permissions

`roles/baremetalsolution.nfsshareseditor` grants 8 permissions in the `baremetalsolution` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/baremetalsolution.nfsshareseditor`](../../overview.md)
