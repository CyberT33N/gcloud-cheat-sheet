# `roles/baremetalsolution.volumeseditor` — `baremetalsolution` permissions

`roles/baremetalsolution.volumeseditor` grants 10 permissions in the `baremetalsolution` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/baremetalsolution.volumeseditor`](../../overview.md)
