# `roles/baremetalsolution.volumesnapshotseditor` — `baremetalsolution` permissions

`roles/baremetalsolution.volumesnapshotseditor` grants 5 permissions in the `baremetalsolution` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/baremetalsolution.volumesnapshotseditor`](../../overview.md)
