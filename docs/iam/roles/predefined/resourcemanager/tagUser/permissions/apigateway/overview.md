# `roles/resourcemanager.tagUser` — `apigateway` permissions

`roles/resourcemanager.tagUser` grants 8 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
