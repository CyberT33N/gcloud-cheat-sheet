...
| Property | Value |
| --- | --- |
| Role ID | `roles/firebase.analyticsAdmin` |
...
`roles/firebase.analyticsAdmin` grants 14 permissions across 5 services. Each service page lists exactly the permissions this role grants on that service and links every permission to its canonical page in the [central permission catalog](../../../../permissions/overview.md).
...
```shell
gcloud iam roles describe roles/firebase.analyticsAdmin --format="value(includedPermissions)"
```
