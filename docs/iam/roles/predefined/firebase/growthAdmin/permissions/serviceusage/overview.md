# `roles/firebase.growthAdmin` — `serviceusage` permissions

`roles/firebase.growthAdmin` grants 14 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
