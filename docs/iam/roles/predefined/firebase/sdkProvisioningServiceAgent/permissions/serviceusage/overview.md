# `roles/firebase.sdkProvisioningServiceAgent` — `serviceusage` permissions

`roles/firebase.sdkProvisioningServiceAgent` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/firebase.sdkProvisioningServiceAgent`](../../overview.md)
