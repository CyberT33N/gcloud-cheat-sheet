# `roles/firebase.managementServiceAgent` — `serviceusage` permissions

`roles/firebase.managementServiceAgent` grants 12 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
