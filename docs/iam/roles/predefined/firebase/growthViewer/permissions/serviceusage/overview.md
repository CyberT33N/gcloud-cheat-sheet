# `roles/firebase.growthViewer` — `serviceusage` permissions

`roles/firebase.growthViewer` grants 14 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
