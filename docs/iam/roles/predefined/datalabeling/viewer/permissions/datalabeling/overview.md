# `roles/datalabeling.viewer` — `datalabeling` permissions

`roles/datalabeling.viewer` grants 14 permissions in the `datalabeling` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
