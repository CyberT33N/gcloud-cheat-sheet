# `roles/aiplatform.telemetryServiceAgent` — `monitoring` permissions

`roles/aiplatform.telemetryServiceAgent` grants 7 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/aiplatform.telemetryServiceAgent`](../../overview.md)
