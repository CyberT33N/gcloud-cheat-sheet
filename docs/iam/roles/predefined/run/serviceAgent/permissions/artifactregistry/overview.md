# `roles/run.serviceAgent` — `artifactregistry` permissions

`roles/run.serviceAgent` grants 33 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
