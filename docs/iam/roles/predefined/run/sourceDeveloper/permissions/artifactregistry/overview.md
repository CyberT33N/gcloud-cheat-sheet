# `roles/run.sourceDeveloper` — `artifactregistry` permissions

`roles/run.sourceDeveloper` grants 33 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
