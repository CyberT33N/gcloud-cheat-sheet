# `roles/firebaseapphosting.computeRunner` — `artifactregistry` permissions

`roles/firebaseapphosting.computeRunner` grants 44 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
