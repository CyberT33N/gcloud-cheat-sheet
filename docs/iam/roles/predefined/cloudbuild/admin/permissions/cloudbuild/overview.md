# `roles/cloudbuild.admin` — `cloudbuild` permissions

`roles/cloudbuild.admin` grants 35 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
