# `roles/cloudbuild.editor` — `cloudbuild` permissions

`roles/cloudbuild.editor` grants 32 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
