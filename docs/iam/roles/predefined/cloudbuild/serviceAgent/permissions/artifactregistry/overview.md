# `roles/cloudbuild.serviceAgent` — `artifactregistry` permissions

`roles/cloudbuild.serviceAgent` grants 45 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
