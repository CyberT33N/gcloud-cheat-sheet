# `roles/ml.admin` — `ml` permissions

`roles/ml.admin` grants 38 permissions in the `ml` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
- [`ml.jobs.setIamPolicy`](../../../../../../permissions/ml/jobs/overview.md)
