# `roles/firebasemods.serviceAgent` — `serviceusage` permissions

`roles/firebasemods.serviceAgent` grants 12 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
