# `roles/servicemanagement.quotaAdmin` — `serviceusage` permissions

`roles/servicemanagement.quotaAdmin` grants 14 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/servicemanagement.quotaAdmin`](../../overview.md)
