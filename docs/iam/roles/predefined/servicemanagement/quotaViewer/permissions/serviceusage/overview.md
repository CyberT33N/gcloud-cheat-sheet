# `roles/servicemanagement.quotaViewer` — `serviceusage` permissions

`roles/servicemanagement.quotaViewer` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/servicemanagement.quotaViewer`](../../overview.md)
