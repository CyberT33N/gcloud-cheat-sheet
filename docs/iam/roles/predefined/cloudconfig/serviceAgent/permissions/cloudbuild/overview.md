# `roles/cloudconfig.serviceAgent` — `cloudbuild` permissions

`roles/cloudconfig.serviceAgent` grants 5 permissions in the `cloudbuild` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
