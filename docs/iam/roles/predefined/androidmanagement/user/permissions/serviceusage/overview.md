# `roles/androidmanagement.user` — `serviceusage` permissions

`roles/androidmanagement.user` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/androidmanagement.user`](../../overview.md)
