# `roles/lifesciences.editor` — `lifesciences` permissions

`roles/lifesciences.editor` grants 4 permissions in the `lifesciences` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/lifesciences.editor`](../../overview.md)
