# `roles/serviceusage.serviceUsageConsumer` — `serviceusage` permissions

`roles/serviceusage.serviceUsageConsumer` grants 15 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/serviceusage.serviceUsageConsumer`](../../overview.md)
