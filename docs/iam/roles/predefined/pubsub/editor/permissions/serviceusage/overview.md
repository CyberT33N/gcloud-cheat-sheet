# `roles/pubsub.editor` — `serviceusage` permissions

`roles/pubsub.editor` grants 10 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
