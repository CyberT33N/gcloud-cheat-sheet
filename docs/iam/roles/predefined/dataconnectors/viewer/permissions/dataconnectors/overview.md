# `roles/dataconnectors.viewer` — `dataconnectors` permissions

`roles/dataconnectors.viewer` grants 7 permissions in the `dataconnectors` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
