# `roles/dataconnectors.connectorAdmin` — `dataconnectors` permissions

`roles/dataconnectors.connectorAdmin` grants 14 permissions in the `dataconnectors` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
- [`dataconnectors.connectors.setIamPolicy`](../../../../../../permissions/dataconnectors/connectors/overview.md)
...
Role: [`roles/dataconnectors.connectorAdmin`](../../overview.md)
