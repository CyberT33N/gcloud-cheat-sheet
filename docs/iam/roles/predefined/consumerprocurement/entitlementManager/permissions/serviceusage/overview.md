# `roles/consumerprocurement.entitlementManager` — `serviceusage` permissions

`roles/consumerprocurement.entitlementManager` grants 13 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/consumerprocurement.entitlementManager`](../../overview.md)
