# `roles/consumerprocurement.entitlementViewer` — `serviceusage` permissions

`roles/consumerprocurement.entitlementViewer` grants 9 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
