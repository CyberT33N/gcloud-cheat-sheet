# `roles/apigateway_management.serviceAgent` — `serviceusage` permissions

`roles/apigateway_management.serviceAgent` grants 8 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/apigateway_management.serviceAgent`](../../overview.md)
