# `roles/artifactregistry.writer` — `artifactregistry` permissions

`roles/artifactregistry.writer` grants 43 permissions in the `artifactregistry` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/artifactregistry.writer`](../../overview.md)
