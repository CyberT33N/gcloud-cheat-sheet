...
| Property | Value |
| --- | --- |
| Role ID | `roles/bigquerymigration.migrationEditor` |
| Title | Migration Management Editor |
...
```shell
gcloud iam roles describe roles/bigquerymigration.migrationEditor --format="value(includedPermissions)"
```
