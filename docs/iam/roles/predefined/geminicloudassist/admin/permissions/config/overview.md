# `roles/geminicloudassist.admin` — `config` permissions

`roles/geminicloudassist.admin` grants 17 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
