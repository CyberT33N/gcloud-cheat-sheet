# `roles/geminicloudassist.editor` — `config` permissions

`roles/geminicloudassist.editor` grants 17 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
