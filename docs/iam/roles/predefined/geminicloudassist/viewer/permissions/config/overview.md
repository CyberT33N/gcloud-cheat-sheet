# `roles/geminicloudassist.viewer` — `config` permissions

`roles/geminicloudassist.viewer` grants 16 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
