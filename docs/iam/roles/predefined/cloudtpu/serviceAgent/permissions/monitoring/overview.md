# `roles/cloudtpu.serviceAgent` — `monitoring` permissions

`roles/cloudtpu.serviceAgent` grants 6 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
