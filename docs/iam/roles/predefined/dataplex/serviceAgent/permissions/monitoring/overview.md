# `roles/dataplex.serviceAgent` — `monitoring` permissions

`roles/dataplex.serviceAgent` grants 11 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
