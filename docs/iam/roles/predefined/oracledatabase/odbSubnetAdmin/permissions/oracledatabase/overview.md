# `roles/oracledatabase.odbSubnetAdmin` — `oracledatabase` permissions

`roles/oracledatabase.odbSubnetAdmin` grants 13 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/oracledatabase.odbSubnetAdmin`](../../overview.md)
