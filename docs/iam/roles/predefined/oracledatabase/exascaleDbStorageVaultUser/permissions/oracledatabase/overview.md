# `roles/oracledatabase.exascaleDbStorageVaultUser` — `oracledatabase` permissions

`roles/oracledatabase.exascaleDbStorageVaultUser` grants 12 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/oracledatabase.exascaleDbStorageVaultUser`](../../overview.md)
