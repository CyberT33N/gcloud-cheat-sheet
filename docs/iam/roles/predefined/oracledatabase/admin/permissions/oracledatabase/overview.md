# `roles/oracledatabase.admin` — `oracledatabase` permissions

`roles/oracledatabase.admin` grants 104 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
