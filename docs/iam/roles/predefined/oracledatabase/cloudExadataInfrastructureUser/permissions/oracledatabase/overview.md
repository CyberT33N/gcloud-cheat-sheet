# `roles/oracledatabase.cloudExadataInfrastructureUser` — `oracledatabase` permissions

`roles/oracledatabase.cloudExadataInfrastructureUser` grants 12 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/oracledatabase.cloudExadataInfrastructureUser`](../../overview.md)
