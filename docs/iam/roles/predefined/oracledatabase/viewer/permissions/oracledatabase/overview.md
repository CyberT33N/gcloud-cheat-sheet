# `roles/oracledatabase.viewer` — `oracledatabase` permissions

`roles/oracledatabase.viewer` grants 44 permissions in the `oracledatabase` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
