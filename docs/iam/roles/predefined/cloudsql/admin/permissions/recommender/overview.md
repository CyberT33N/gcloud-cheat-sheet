# `roles/cloudsql.admin` — `recommender` permissions

`roles/cloudsql.admin` grants 51 permissions in the `recommender` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
