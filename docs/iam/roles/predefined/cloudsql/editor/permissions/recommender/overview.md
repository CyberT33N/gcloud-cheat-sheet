# `roles/cloudsql.editor` — `recommender` permissions

`roles/cloudsql.editor` grants 45 permissions in the `recommender` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
