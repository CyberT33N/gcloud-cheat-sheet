# `roles/commerceproducer.viewer` — `commerceproducer` permissions

`roles/commerceproducer.viewer` grants 20 permissions in the `commerceproducer` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/commerceproducer.viewer`](../../overview.md)
