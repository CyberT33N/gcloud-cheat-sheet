# `roles/securitycenter.serviceAgent` — `iam.googleapis.com` permissions

`roles/securitycenter.serviceAgent` grants 2 permissions in the `iam.googleapis.com` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
