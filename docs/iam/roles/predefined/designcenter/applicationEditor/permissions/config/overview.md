# `roles/designcenter.applicationEditor` — `config` permissions

`roles/designcenter.applicationEditor` grants 21 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
