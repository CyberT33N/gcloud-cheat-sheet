# `roles/designcenter.applicationViewer` — `config` permissions

`roles/designcenter.applicationViewer` grants 20 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
