# `roles/designcenter.applicationAdmin` — `config` permissions

`roles/designcenter.applicationAdmin` grants 21 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
