# `roles/cloudsecuritycompliance.serviceAgent` — `serviceusage` permissions

`roles/cloudsecuritycompliance.serviceAgent` grants 16 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
