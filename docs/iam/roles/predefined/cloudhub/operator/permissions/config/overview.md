# `roles/cloudhub.operator` — `config` permissions

`roles/cloudhub.operator` grants 20 permissions in the `config` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
