# `roles/commercebusinessenablement.admin` — `resourcemanager` permissions

`roles/commercebusinessenablement.admin` grants 3 permissions in the `resourcemanager` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
