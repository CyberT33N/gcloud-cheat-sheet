# `roles/cloudlocationfinder.viewer` — `cloudlocationfinder` permissions

`roles/cloudlocationfinder.viewer` grants 5 permissions in the `cloudlocationfinder` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
...
Role: [`roles/cloudlocationfinder.viewer`](../../overview.md)
