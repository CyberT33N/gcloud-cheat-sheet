# `roles/apigateway.editor` — `apigateway` permissions

`roles/apigateway.editor` grants 28 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
