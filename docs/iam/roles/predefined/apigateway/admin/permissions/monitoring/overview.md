# `roles/apigateway.admin` — `monitoring` permissions

`roles/apigateway.admin` grants 3 permissions in the `monitoring` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
