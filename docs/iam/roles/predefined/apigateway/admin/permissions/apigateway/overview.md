# `roles/apigateway.admin` — `apigateway` permissions

`roles/apigateway.admin` grants 35 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
