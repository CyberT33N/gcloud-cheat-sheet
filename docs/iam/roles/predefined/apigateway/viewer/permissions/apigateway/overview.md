# `roles/apigateway.viewer` — `apigateway` permissions

`roles/apigateway.viewer` grants 17 permissions in the `apigateway` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
