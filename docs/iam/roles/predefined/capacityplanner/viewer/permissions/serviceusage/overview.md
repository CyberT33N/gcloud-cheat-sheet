# `roles/capacityplanner.viewer` — `serviceusage` permissions

`roles/capacityplanner.viewer` grants 7 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
