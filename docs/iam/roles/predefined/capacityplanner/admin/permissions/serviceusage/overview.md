# `roles/capacityplanner.admin` — `serviceusage` permissions

`roles/capacityplanner.admin` grants 7 permissions in the `serviceusage` service area. Every permission links to its canonical page in the [central permission catalog](../../../../../../permissions/overview.md).
